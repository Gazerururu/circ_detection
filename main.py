...
img_binary = cv2.adaptiveThreshold(img_blur, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 51, 2)
display('binary', img_binary)

circles = cv2.HoughCircles(img_binary, cv2.HOUGH_GRADIENT, dp=1, minDist=150, param1=100, param2=35, minRadius=50, maxRadius=200)
